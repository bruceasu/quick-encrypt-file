 ...
 */
/*
 * $Id: me.asu.quick.util.GetOpt.java,v 1.2.4.1 2005/08/31 11:46:04 pvedula Exp $
 */
...
/**
 * me.asu.quick.util.GetOpt is a Java equivalent to the C getopt() library function
...
public class GetOpt {
    ...
    private static final String PAD_2_SPC  = dup(' ', 2);
    ...
    public void printUsage(String cmdName, Map<String, String> description) {
        ...
        if (theOptString != null && !theOptString.isEmpty()) {
            builder.append(" [options] [arguments]\n");
            builder.append(PAD_2_SPC).append("[options]:\n");
        ...
        if(description.containsKey("[arguments]")) {
            builder.append('\n')
                   .append(PAD_2_SPC)
                   .append("[arguments]:")
                   .append('\n');
            builder.append(PAD_4_SPC)
                   .append(formatUsageDescription(
...
}// end class me.asu.quick.util.GetOpt
